...
| `graphhopper_api_key` | GraphHopper Directions API key for trailhead-to-point routing (distance, elevation, instructions). Get at https://www.graphhopper.com/ |
...
Or set env vars: `GOOGLE_API_KEY`, `OPENWEATHERMAP_API_KEY`, `GOOGLE_MAPS_API_KEY`, `GRAPHHOPPER_API_KEY`.
